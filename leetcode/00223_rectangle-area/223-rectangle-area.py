...
class Rectangle:
    ...
    def get_overlapped_rec(self, rec):
        if rec.p2.x < self.p1.x and rec.p1.x < self.p1.x or \
           rec.p2.x > self.p2.x and rec.p1.x > self.p2.x or \
           rec.p2.y < self.p1.y and rec.p1.y < self.p1.y or \
           rec.p2.y > self.p2.y and rec.p1.y > self.p2.y:
